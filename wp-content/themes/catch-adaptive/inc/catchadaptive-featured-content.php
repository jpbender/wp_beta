	...
	if ( $enablecontent == 'entire-site' || ( ( is_front_page() || ( is_home() && $page_for_posts != $page_id ) ) && $enablecontent == 'homepage' ) ) {
		if( ( !$catchadaptive_featured_content = get_transient( 'catchadaptive_featured_content_display' ) ) ) {
			...
			if( $contentselect == 'demo-featured-content' ) {
				...
				$subheadline 	= __( 'Here you can showcase the x number of Featured Content. You can edit this Headline, Subheadline and Feaured Content from "Appearance -> Customize -> Featured Content Options".', 'catchadaptive' );
			} 
...
function catchadaptive_demo_content( $options ) {
	...
	<div class="featured_content_slider_wrap">
		<article id="featured-post-1" class="post hentry post-demo">
			<figure class="featured-content-image">
				<img alt="' .  __( 'Central Park', 'catchadaptive' ) . '" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured1-400x225.jpg" />
			</figure>
			<div class="entry-container">
				<header class="entry-header">
					<h1 class="entry-title">
						' .  __( 'Central Park', 'catchadaptive' ) . '
					</h1>
				</header>
			</div><!-- .entry-container -->			
		</article>
		...
		<article id="featured-post-2" class="post hentry post-demo">
			<figure class="featured-content-image">
				<img alt="' .  __( 'Antique Clock', 'catchadaptive' ) . '" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured2-400x225.jpg" />
			</figure>
			<div class="entry-container">
				<header class="entry-header">
					<h1 class="entry-title">
						' .  __( 'Antique Clock', 'catchadaptive' ) . '
					</h1>
				</header>
			</div><!-- .entry-container -->			
		</article>
		...
		<article id="featured-post-3" class="post hentry post-demo">
			<figure class="featured-content-image">
				<img alt="' .  __( 'Vespa Scooter', 'catchadaptive' ) . '" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured3-400x225.jpg" />
			</figure>
			<div class="entry-container">
				<header class="entry-header">
					<h1 class="entry-title">
						' . __( 'Vespa Scooter', 'catchadaptive' ) . '
					</h1>
				</header>
			</div><!-- .entry-container -->			
		</article>';
	...
	if( 'layout-four' == $options ['featured_content_layout']) {
		...
		<article id="featured-post-4" class="post hentry post-demo">
			<figure class="featured-content-image">
				<img alt="' .  __( 'Dhulikhel', 'catchadaptive' ) . '" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured4-400x225.jpg" />
			</figure>
			<div class="entry-container">
				<header class="entry-header">
					<h1 class="entry-title">
						' .  __( 'Dhulikhel', 'catchadaptive' ) . '
					</h1>
				</header>
			</div><!-- .entry-container -->			
		</article>';
