	...
	$catchadaptive_demo_slider ='
								<article class="post hentry slides demo-image displayblock">
									<figure class="slider-image">
										<a title="' .  esc_attr( __( 'Slider Image 1', 'catchadaptive' ) ) . '" href="'. esc_url( home_url( '/' ) ) .'">
											<img src="'.get_template_directory_uri().'/images/gallery/slider1-1680x720.jpg" class="wp-post-image" alt="' .  esc_attr( __( 'Slider Image 1', 'catchadaptive' ) ) . '" title="' .  esc_attr( __( 'Slider Image 1', 'catchadaptive' ) ) . '">
										</a>
									</figure>
									<div class="entry-container">
										<header class="entry-header">
											<h1 class="entry-title">
												<a title="' .  esc_attr( __( 'Slider Image 1', 'catchadaptive' ) ) . '" href="#"><span>' .  __( 'Slider Image 1', 'catchadaptive' ) . '</span></a>
											</h1>

											<div class="assistive-text">
												<span class="post-time">
													' . __( 'Posted on', 'catchadaptive' ) .'
												...
												<span class="post-author">
													' . sprintf( _x( 'By', 'attribution', 'catchadaptive' ) ) . '&nbsp;
													<span class="author vcard">
														<a rel="author" title="' .  esc_attr( __( 'View all posts by', 'catchadaptive' ) ) . ' Catch Themes" href="#" class="url fn n">Catch Themes</a>
													</span>
												</span>
											</div>
										</header>
										<div class="entry-content">
											<p>' . __( 'Slider Image 1 Content', 'catchadaptive' ) . '</p>
										</div>   
									</div>             
								</article><!-- .slides --> 	
								...
								<article class="post hentry slides demo-image displaynone">
									<figure class="slider-image">
										<a title="' .  esc_attr( __( 'Slider Image 2', 'catchadaptive' ) ) . '" href="'. esc_url( home_url( '/' ) ) .'">
											<img src="'. get_template_directory_uri() . '/images/gallery/slider2-1680x720.jpg" class="wp-post-image" alt="' .  esc_attr( __( 'Slider Image 2', 'catchadaptive' ) ) . '" title="' .  esc_attr( __( 'Slider Image 2', 'catchadaptive' ) ) . '">
										</a>
									</figure>
									<div class="entry-container">
										<header class="entry-header">
											<h1 class="entry-title">
												<a title="' .  esc_attr( __( 'Slider Image 1', 'catchadaptive' ) ) . '" href="#"><span>' .  __( 'Slider Image 2', 'catchadaptive' ) . '</span></a>
											</h1>
											<div class="assistive-text">
												<span class="post-time">
													' . __( 'Posted on', 'catchadaptive' ) .'
										...
										<div class="entry-content">
											<p>' . __( 'Slider Image 2 Content', 'catchadaptive' ) . '</p>
										</div>   
									</div>             
								</article><!-- .slides --> ';
		...
		while ( $get_featured_posts->have_posts()) : $get_featured_posts->the_post(); $i++;
			...
			<article class="'.$classes.'">
				...
				if ( has_post_thumbnail() ) {
					$catchadaptive_post_slider .= '<a title="' . the_title_attribute( array( 'before' => __( 'Permalink to:', 'catchadaptive' ), 'echo' => false ) ) . '" href="' . get_permalink() . '">
	...
	if ( !empty( $page_list ) && $number_of_page > 0 ) {
		...
		while ( $get_featured_posts->have_posts()) : $get_featured_posts->the_post(); $i++;
			...
			<article class="'.$classes.'">
				<figure class="slider-image">';
				if ( has_post_thumbnail() ) {
					$catchadaptive_page_slider .= '<a title="' . the_title_attribute( array( 'before' => __( 'Permalink to:', 'catchadaptive' ), 'echo' => false ) ) . '" href="' . get_permalink() . '">
						'. get_the_post_thumbnail( $post->ID, 'catchadaptive_slider', array( 'title' => esc_attr( $title_attribute ), 'alt' => esc_attr( $title_attribute ), 'class'	=> 'pngfix' ) ).'
					</a>';
				}
				else {
