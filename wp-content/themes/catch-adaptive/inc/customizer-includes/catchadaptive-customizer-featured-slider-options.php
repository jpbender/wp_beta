...
if ( ! defined( 'CATCHADAPTIVE_THEME_VERSION' ) ) {
	...
	if( 4 <= get_bloginfo( 'version' ) ) {
		$wp_customize->add_panel( 'catchadaptive_featured_slider', array(
		    ...
		    'description'    => __( 'Options for Featured Slider', 'catchadaptive' ),
		    'priority'       => 500,
			'title'    		 => __( 'Featured Slider', 'catchadaptive' ),
		) );
	}
	...
	$wp_customize->add_section( 'catchadaptive_featured_slider', array(
		...
		'priority'		=> 1,
		'title'			=> __( 'Featured Slider Options', 'catchadaptive' ),
	) );
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[featured_slider_option]', array(
		'choices'   => $choices,
		'label'    	=> __( 'Enable Slider on', 'catchadaptive' ),
		'priority'	=> '2',
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[featured_slide_transition_effect]' , array(
		'choices'  	=> $choices,
		'label'		=> __( 'Transition Effect', 'catchadaptive' ),
		'priority'	=> '3',
		'section'  	=> 'catchadaptive_featured_slider',
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[featured_slide_transition_delay]' , array(
		'description'	=> __( 'seconds(s)', 'catchadaptive' ),
		'input_attrs' => array(
        	'style' => 'width: 40px;'
    	),
    	'label'    		=> __( 'Transition Delay', 'catchadaptive' ),
		'priority'		=> '4',
		'section'  		=> 'catchadaptive_featured_slider',
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[featured_slide_transition_length]' , array(
    	...
    	'label'    		=> __( 'Transition Length', 'catchadaptive' ),
		'priority'		=> '5',
		'section'  		=> 'catchadaptive_featured_slider',
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[featured_slider_image_loader]', array(
		'choices'   => $choices,
		'label'    	=> __( 'Image Loader', 'catchadaptive' ),
		'priority'	=> '6',
		'section'  	=> 'catchadaptive_featured_slider',
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[featured_slider_type]', array(
		'choices'  	=> $choices,
		'label'    	=> __( 'Select Slider Type', 'catchadaptive' ),
		'priority'	=> '7',
		'section'  	=> 'catchadaptive_featured_slider',
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[featured_slide_number]' , array(
		'description'	=> __( 'Save and refresh the page if No. of Slides is changed (Max no of slides is 20)', 'catchadaptive' ),
		'input_attrs' 	=> array(
            'style' => 'width: 45px;',
            'min'   => 0,
            'max'   => 20,
		...
		'label'    		=> __( 'No of Slides', 'catchadaptive' ),
		'priority'		=> '8',
		'section'  		=> 'catchadaptive_featured_slider',
