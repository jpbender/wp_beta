...
//Theme Options
	if( 4 <= get_bloginfo( 'version' ) ) {
		$wp_customize->add_panel( 'catchadaptive_theme_options', array(
		    'description'    => __( 'Basic theme Options', 'catchadaptive' ),
		    'capability'     => 'edit_theme_options',
		    'priority'       => 200,
		    'title'    		 => __( 'Theme Options', 'catchadaptive' ),
		) );
	}

	// Breadcrumb Option
	$wp_customize->add_section( 'catchadaptive_breadcumb_options', array(
		'description'	=> __( 'Breadcrumbs are a great way of letting your visitors find out where they are on your site with just a glance. You can enable/disable them on homepage and entire site.', 'catchadaptive' ),
		'panel'			=> 'catchadaptive_theme_options',
		'title'    		=> __( 'Breadcrumb Options', 'catchadaptive' ),
		'priority' 		=> 201,
	) );
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[breadcumb_option]', array(
		'label'    => __( 'Check to enable Breadcrumb', 'catchadaptive' ),
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[breadcumb_onhomepage]', array(
		'label'    => __( 'Check to enable Breadcrumb on Homepage', 'catchadaptive' ),
		'section'  => 'catchadaptive_breadcumb_options',
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[breadcumb_seperator]', array(
    	...
    	'label'    	=> __( 'Separator between Breadcrumbs', 'catchadaptive' ),
		'section' 	=> 'catchadaptive_breadcumb_options',
	...
	$wp_customize->add_section( 'catchadaptive_custom_css', array(
		'description'	=> __( 'Custom/Inline CSS', 'catchadaptive'),
		'panel'  		=> 'catchadaptive_theme_options',
		'priority' 		=> 203,
		'title'    		=> __( 'Custom CSS Options', 'catchadaptive' ),
	) );
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[custom_css]', array(
		'label'		=> __( 'Enter Custom CSS', 'catchadaptive' ),
        'priority'	=> 1,
	...
	$wp_customize->add_section( 'catchadaptive_excerpt_options', array(
		'panel'  	=> 'catchadaptive_theme_options',
		'priority' 	=> 204,
		'title'    	=> __( 'Excerpt Options', 'catchadaptive' ),
	) );
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[excerpt_length]', array(
		'description' => __('Excerpt length. Default is 40 words', 'catchadaptive'),
		'input_attrs' => array(
            'min'   => 10,
            'max'   => 200,
            'step'  => 5,
        ...
        'label'    => __( 'Excerpt Length (words)', 'catchadaptive' ),
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[excerpt_more_text]', array(
		'label'    => __( 'Read More Text', 'catchadaptive' ),
		'section'  => 'catchadaptive_excerpt_options',
	...
	$wp_customize->add_section( 'catchadaptive_homepage_options', array(
		'description'	=> __( 'Only posts that belong to the categories selected here will be displayed on the front page', 'catchadaptive' ),
		'panel'			=> 'catchadaptive_theme_options',
		'priority' 		=> 209,
		'title'   	 	=> __( 'Homepage / Frontpage Options', 'catchadaptive' ),
	) );
	...
	$wp_customize->add_control( new Catchadaptive_Customize_Dropdown_Categories_Control( $wp_customize, 'catchadaptive_theme_options[front_page_category]', array(
        'label'   	=> __( 'Select Categories', 'catchadaptive' ),
	...
	$wp_customize->add_section( 'catchadaptive_icons', array(
		'description'	=> __( 'Remove Icon images to disable.', 'catchadaptive'),
		'panel'  => 'catchadaptive_theme_options',
		'title'    		=> __( 'Icon Options', 'catchadaptive' ),
		'priority' 		=> 210,
	) );
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'catchadaptive_theme_options[favicon]', array(
		'label'		=> __( 'Select/Add Favicon', 'catchadaptive' ),
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'catchadaptive_theme_options[web_clip]', array(
		'description'	=> __( 'Web Clip Icon for Apple devices. Recommended Size - Width 144px and Height 144px height, which will support High Resolution Devices like iPad Retina.', 'catchadaptive'),
		'label'		 	=> __( 'Select/Add Web Clip Icon', 'catchadaptive' ),
		'section'    	=> 'catchadaptive_icons',
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'catchadaptive_theme_options[logo_icon]', array(
		'label'		 	=> __( 'Select/Add Logo Icon', 'catchadaptive' ),
		'section'    	=> 'catchadaptive_icons',
	...
	$wp_customize->add_section( 'catchadaptive_layout', array(
		...
		'panel'		=> 'catchadaptive_theme_options',
		'priority'	=> 211,
		'title'		=> __( 'Layout Options', 'catchadaptive' ),
	) );
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[theme_layout]', array(
		'choices'	=> $choices,
		'label'		=> __( 'Default Layout', 'catchadaptive' ),
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[content_layout]', array(
		'choices'   => $choices,
		'label'		=> __( 'Archive Content Layout', 'catchadaptive' ),
		'section'   => 'catchadaptive_layout',
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[single_post_image_layout]', array(
			'label'		=> __( 'Single Page/Post Image Layout ', 'catchadaptive' ),
			'section'   => 'catchadaptive_layout',
	...
	if ( ( 'infinite-scroll-click' == $pagination_type || 'infinite-scroll-scroll' == $pagination_type ) ) {
		if ( ! (class_exists( 'Jetpack' ) && Jetpack::is_module_active( 'infinite-scroll' ) ) ) {
			$catchadaptive_navigation_description = sprintf( __( 'Infinite Scroll Options requires <a target="_blank" href="%s">JetPack Plugin</a> with Infinite Scroll module Enabled.', 'catchadaptive' ), esc_url( 'https://wordpress.org/plugins/jetpack/' ) );
		}
		else {
	...
	*/
		...
		if ( !function_exists( 'wp_pagenavi' ) ) {
			$catchadaptive_navigation_description = sprintf( __( 'Numeric Option requires <a target="_blank" href="%s">WP-PageNavi Plugin</a>.', 'catchadaptive' ), esc_url( 'https://wordpress.org/plugins/wp-pagenavi' ) );
		}
		else {
			$catchadaptive_navigation_description = '';
		}
	...
	$wp_customize->add_section( 'catchadaptive_pagination_options', array(
		...
		'panel'  		=> 'catchadaptive_theme_options',
		'priority'		=> 212,
		'title'    		=> __( 'Pagination Options', 'catchadaptive' ),
	) );
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[pagination_type]', array(
		'choices'  => $choices,
		'label'    => __( 'Pagination type', 'catchadaptive' ),
    ...
    $wp_customize->add_section( 'catchadaptive_promotion_headline_options', array(
		'description'	=> __( 'To disable the fields, simply leave them empty.', 'catchadaptive' ),
		'panel'			=> 'catchadaptive_theme_options',
		'priority' 		=> 213,
		'title'   	 	=> __( 'Promotion Headline Options', 'catchadaptive' ),
	) );
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[promotion_headline_option]', array(
		'choices'  	=> $choices,
		'label'    	=> __( 'Enable Promotion Headline on', 'catchadaptive' ),
		'priority'	=> '0.5',
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[promotion_headline]', array(
		'description'	=> __( 'Appropriate Words: 10', 'catchadaptive' ),
		'label'    	=> __( 'Promotion Headline Text', 'catchadaptive' ),
		'priority'	=> '1',
		'section' 	=> 'catchadaptive_promotion_headline_options',
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[promotion_subheadline]', array(
		'description'	=> __( 'Appropriate Words: 15', 'catchadaptive' ),
		'label'    		=> __( 'Promotion Subheadline Text', 'catchadaptive' ),
		'priority'		=> '2',
		'section' 		=> 'catchadaptive_promotion_headline_options',
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[promotion_headline_button]', array(
		'description'	=> __( 'Appropriate Words: 3', 'catchadaptive' ),
		'label'    	=> __( 'Promotion Headline Button Text ', 'catchadaptive' ),
		'priority'	=> '3',
		'section' 	=> 'catchadaptive_promotion_headline_options',
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[promotion_headline_url]', array(
		'label'    	=> __( 'Promotion Headline Link', 'catchadaptive' ),
		'priority'	=> '4',
		'section' 	=> 'catchadaptive_promotion_headline_options',
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[promotion_headline_target]', array(
		'label'    	=> __( 'Check to Open Link in New Window/Tab', 'catchadaptive' ),
		'priority'	=> '5',
		'section'  	=> 'catchadaptive_promotion_headline_options',
	...
	$wp_customize->add_section( 'catchadaptive_search_options', array(
		'description'=> __( 'Change default placeholder text in Search.', 'catchadaptive'),
		'panel'  => 'catchadaptive_theme_options',
		'priority' => 216,
		'title'    => __( 'Search Options', 'catchadaptive' ),
	) );
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[search_text]', array(
		'label'		=> __( 'Default Display Text in Search', 'catchadaptive' ),
