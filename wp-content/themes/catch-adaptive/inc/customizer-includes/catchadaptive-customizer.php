...
function catchadaptive_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[logo_disable]', array(
		'label'    => __( 'Check to disable logo', 'catchadaptive' ),
		'priority' => 101,
		'section'  => 'title_tagline',
	...
	$wp_customize->add_control( 'catchadaptive_logo_alt_text', array(
		'label'    	=> __( 'Logo Alt Text', 'catchadaptive' ),
		'priority'	=> 102,
		'section' 	=> 'title_tagline',
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[move_title_tagline]', array(
		'label'    => __( 'Check to move Site Title and Tagline before logo', 'catchadaptive' ),
		'priority' => 103,
		'section'  => 'title_tagline',
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[color_scheme]', array(
		'choices'  => $choices,
		'label'    => __( 'Color Scheme', 'catchadaptive' ),
		'priority' => 5,
		'section'  => 'colors',
	...
	$wp_customize->add_section( 'catchadaptive_reset_all_settings', array(
		'description'	=> __( 'Caution: Reset all settings to default. Refresh the page after save to view full effects.', 'catchadaptive' ),
		'priority' 		=> 700,
		'title'    		=> __( 'Reset all settings', 'catchadaptive' ),
	) );
	...
	$wp_customize->add_control( 'catchadaptive_theme_options[reset_all_settings]', array(
		'label'    => __( 'Check to reset all settings to default', 'catchadaptive' ),
	...
	//Important Links
		$wp_customize->add_section( 'important_links', array(
			'priority' 		=> 999,
			'title'   	 	=> __( 'Important Links', 'catchadaptive' ),
		) );
		...
		$wp_customize->add_control( new Catchadaptive_Important_Links( $wp_customize, 'important_links', array(
	        'label'   	=> __( 'Important Links', 'catchadaptive' ),
...
function catchadaptive_sanitize_number_range( $number, $setting ) {
	...
	$atts = $wp_customize_->get_control( $setting->id )->input_attrs;
...
function catchadaptive_customize_scripts() {
	...
	$catchadaptive_misc_links = array(
							...
							'upgrade_text'	 			=> __( 'Upgrade To Pro &raquo;', 'catchadaptive' ),
							'WP_version'				=> get_bloginfo( 'version' ),
							'old_version_message'		=> __( 'Some settings might be missing or disorganized in this version of WordPress. So we suggest you to upgrade to version 4.0 or better.', 'catchadaptive' )
		);
