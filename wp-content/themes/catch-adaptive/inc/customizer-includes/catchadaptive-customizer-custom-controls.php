...
if ( ! defined( 'CATCHADAPTIVE_THEME_VERSION' ) ) {
	...
	class Catchadaptive_Customize_Dropdown_Categories_Control extends WP_Customize_Control {
		...
		public function render_content() {
			...
			echo '<p class="description">'. __( 'Hold down the Ctrl (windows) / Command (Mac) button to select multiple options.', 'catchadaptive' ) . '</p>';
		}
	}
        ...
        public function render_content() {
            ...
            $important_links = array(
							'theme_instructions' => array( 
								'link'	=> esc_url( 'http://catchthemes.com/theme-instructions/catchadaptive/' ),
								'text' 	=> __( 'Theme Instructions', 'catchadaptive' ),
								),
							'support' => array( 
								'link'	=> esc_url( 'http://catchthemes.com/support/' ),
								'text' 	=> __( 'Support', 'catchadaptive' ),
								),
							'changelog' => array( 
								'link'	=> esc_url( 'http://catchthemes.com/changelogs/catchadaptive-theme/' ),
								'text' 	=> __( 'Changelog', 'catchadaptive' ),
								),
							'donate' => array( 
								'link'	=> esc_url( 'http://catchthemes.com/donate/' ),
								'text' 	=> __( 'Donate Now', 'catchadaptive' ),
								),
							'review' => array( 
								'link'	=> esc_url( 'https://wordpress.org/support/view/theme-reviews/catchadaptive' ),
								'text' 	=> __( 'Review', 'catchadaptive' ),
								),
							);
